...
struct Instruction instruction_table[] = {
    ...
    INST(XCHG, xchg, {OPCODE1(1000011), W, MOD, REG, RM, END}, {OPERAND_ID_REG}, {OPERAND_ID_RM}),
    INST(XCHG, xchg, {OPCODE1(10010), REG, ImplW(1), END}, {OPERAND_ID_ACCUMULATOR}, {OPERAND_ID_REG}),
